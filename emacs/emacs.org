...
#+begin_src emacs-lisp
  ...
  (transient-define-prefix git-transient ()
    "Git transient"
    ["Hunks"
  ...
  (transient-define-prefix toggles-transient ()
    "Toggles transient"
    ["Toggles"
     ("t" "treemacs" treemacs)
     ("s" "LSP symbols"
  ...
  (transient-define-prefix project-transient ()
    ...
    [("p" "switch" projectile-switch-project)
     ...
     ("fr" "find recent" projectile-recentf)
     ("fo" "find other" projectile-find-other-file)
     ("fm" "find others"
      (lambda ()
        (interactive)
  ...
  (transient-define-prefix entry-transient ()
    "Entry"
    [["File"
      ("s" "save" save-buffer)
      ("f" "find" find-file)
     ...
     ["Dired"
      ...
      ("L" "consult line multi" consult-line-multi)
      "Projects"
      ("p" "" project-transient)
      "Toggles"
      ("t" "" toggles-transient)]])
...
#+begin_src emacs-lisp :tangle no
 ;; (defvar default-map (make-sparse-keymap)
...
#+begin_src emacs-lisp
  ...
  (use-package evil
    ...
    ;; (keymap-set global-map "SPC" space-map)
    ;; (keymap-set evil-normal-state-map "SPC" space-map)

    (keymap-set evil-normal-state-map "," 'major-mode-transient)

    ;; (keymap-set evil-visual-state-map "C-w" #'kill-region)
    ;; (keymap-set evil-visual-line-state-map "C-w" #'kill-region)
    ;; (keymap-set evil-normal-state-map "C-w" #'kill-region)
...
#+begin_src emacs-lisp
  (use-package vertico
    :demand t
    :after evil-collection ; We override key-maps below
    :hook
    ...
    (org-roam-capture-templates
     '(
       ...
       ("c" "Chapter note" plain
        "* What this chapter gives me\n%?\n* Key rules\n* Runnable example(s)\n* Links\n- Topic: [[id:]]\n- Pattern: [[id:]]\n"
         :if-new (file+head "notes/books/${slug}.org"
                            "#+title: ${title}\n#+filetags: :book:${book}:\n")
       ...
       ("t" "Topic note" plain
        "* Summary\n%?\n* Cross-links\n- TAPL: [[id:]]\n- PFPL: [[id:]]\n- Pattern: [[id:]]\n- Code: [[file:../../src/ocaml/]]\n"
        :if-new (file+head "notes/topics/${slug}.org"
                           "#+title: ${title}\n#+filetags: :topic:\n")
        :immediate-finish nil)

       ("p" "Pattern note" plain
        "* Context\n\n* Invariant\n\n* Ops that preserve it\n\n* Laws/tests\n\n* Examples\n- OCaml: [[file:../../src/ocaml/]]\n- Go: [[file:../../src/go/]]\n* References\n"
        :if-new (file+head "notes/patterns/${slug}.org"
                           "#+title: Pattern — ${title}\n#+filetags: :pattern:\n")
        :immediate-finish nil)

       ;; Literature note from a BibTeX citekey (org-roam-bibtex)
       ("r" "Reference note" plain
        "* Summary\n%?\n* Key quotes\n* Links\n"
        :if-new (file+head "notes/refs/${citekey}.org"
                           "#+title: ${title}\n#+filetags: :ref:\n#+citekey: ${citekey}\n"))
       ))
...
#+begin_src emacs-lisp
  (use-package citar
    :custom
    (citar-bibliography (expand-file-name "bib/refs.bib" org-directory))
