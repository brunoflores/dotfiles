...
#+begin_src emacs-lisp
  ...
  (my/leader
    "f" '(my/files-transient   :which-key "files")
    "b" '(my/buffers-transient :which-key "buffers"))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (my/leader
    "p" '(my/project-transient :which-key "project"))
#+end_src

** Org transient
#+begin_src emacs-lisp
  (use-package org
    :after org ;; because we mention "org" functions
  ...
  (defun my/org-mode-setup ()
    ;; in org-mode, under leader, "o" calls this transient.
    (my/leader
      :keymaps 'org-mode-map
      "o" '(my/org-transient :which-key "org menu")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package org-roam
    :after org-roam
    :hook (org-roam-mode . my/org-roam-mode-setup)
    :config
  ...
  (defun my/org-roam-mode-setup ()
    ;; Optional: local leader in Org-roam buffers (or org-mode-map if you prefer)
    (my/leader
      :keymaps 'org-roam-mode-map
      "r" '(my/roam-transient :which-key "roam menu")))
#+end_src
...
#+begin_src emacs-lisp
  (transient-define-prefix my/hub-transient ()
    ...
    [["Files / Buffers"
     ...
     ;; ["Misc"
     ;;  ("t" "TAPL / Tools" my/tools-transient)]
     ])

  (my/leader
    "SPC" '(my/hub-transient :which-key "hub"))
#+end_src
