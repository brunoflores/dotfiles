...
#+begin_src emacs-lisp
  (repeat-mode t)                ;; Enable repeating key maps
  (menu-bar-mode 0)              ;; Hide the menu bar
  (tool-bar-mode 0)              ;; Hide the tool bar
  (savehist-mode t)              ;; Save minibuffer history
  (scroll-bar-mode 0)            ;; Hide the scroll bar
  (xterm-mouse-mode t)           ;; Enable mouse events in terminal Emacs
  (display-time-mode t)          ;; Display time in mode line / tab bar
  (fido-vertical-mode 0)         ;; Improved vertical minibuffer completions
  (column-number-mode t)         ;; Show column number on mode line
  (tab-bar-history-mode t)       ;; Remember previous tab window configurations
  (auto-save-visited-mode t)     ;; Auto-save files at an interval
  (global-visual-line-mode t)    ;; Visually wrap long lines in all buffers
  (global-auto-revert-mode t)    ;; Refresh buffers with changed local files
  (winner-mode t)                ;; To navigate window configuration history
  (tooltip-mode t)               ;;
  (global-display-line-numbers-mode 0) ;; Disable line numbers on the left by default
...
#+begin_src emacs-lisp
  (use-package consult
    :demand t
    :init
    (recentf-mode t) ; Enables tracking of recent files
    :hook
...
#+begin_src emacs-lisp
  ...
  (use-package rainbow-delimiters
    ...
    (rainbow-delimiters-depth-4-face
     ((t (:inherit rainbow-delimiters-base-face :foreground "orange red"))))
    (rainbow-delimiters-depth-5-face
     ((t (:inherit rainbow-delimiters-base-face :foreground "hot pink"))))
    (rainbow-delimiters-depth-6-face
     ((t (:inherit rainbow-delimiters-base-face :foreground "peach puff"))))
