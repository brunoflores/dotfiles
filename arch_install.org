...
This relies on having =subvol=@= in =rootflags= in GRUB. The wiki says I should
regenerate the initramfs image, but I don't find it necessary. Maybe when we are
